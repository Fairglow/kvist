...
- **Onboarding and Integration:** `kvist convert` (ONB-01, existing project conversion) and `kvist import` (ONB-02, remote/local Git repository import with validation and automatic conversion/init fallback) are fully implemented and verified.
