...
## Clean-slate documentation pass
...
`DOCS.md`, root contract, architecture specification, prior reviews, or Git
history.

The documenter writes or proposes `DOCS.md` using observed behavior only. It
...
`DOCS.md`, the immediate parent contract, and `ROOT_CONTRACT.md`. The reviewer
...
Do not silently modify `SPEC.md` or `DOCS.md` to erase a mismatch. Retain the
final `DOCS.md`, the review record, and any approved arbitration decision in
